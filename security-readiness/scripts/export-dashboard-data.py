...
payload = {
    ...
    "tests": {
        ...
        "mcp_deny_before_dispatch_runtime_adjacent": item_status(validation, "mcp_deny_before_dispatch_adjacent"),
        "tier4_artifact_writer_scaffold": item_status(validation, "tier4_artifact_writer_scaffold"),
        "tool_runtime_wiring_main_llm_loop": "Not Pass",
        "tool_runtime_wiring_research_agent": "Not Pass",
        "tool_runtime_wiring": "Not Pass",
        "full_mcp_runtime_hardening": "Not Pass",
        "evidence_pack": "Incomplete",
        "mcp_tool_hardening": "Missing / Not Pass",
        "tier4_runtime_execution": "Not Pass / Blocked",
    },
    ...
    "evidence_scope": {
        ...
        "tool_runtime_context_guard_dependency_light": {
            "status": item_status(validation, "tool_runtime_context_guard_dependency_light"),
            "evidence_type": "dependency-light tool runtime context guard evidence",
            "runtime_proof": "No",
        ...
        "mcp_deny_before_dispatch_runtime_adjacent": {
            "status": item_status(validation, "mcp_deny_before_dispatch_adjacent"),
            "evidence_type": "runtime-adjacent MCP deny-before-dispatch evidence",
            "runtime_proof": "No (runtime-adjacent only; full MCP/runtime hardening remains NOT_PASS)",
            "launch_gate_effect": "Non-critical positive signal only; does not satisfy full MCP/runtime or tool hardening requirements",
        },
        "tier4_artifact_writer_scaffold": {
            "status": item_status(validation, "tier4_artifact_writer_scaffold"),
            "evidence_type": "artifact writer scaffold test evidence",
            "runtime_proof": "No (scaffold-only; tier4_runtime_status remains NOT_PASS)",
            "launch_gate_effect": "Non-critical scaffold signal only; does not satisfy Tier 4 runtime blockers for retrieval/citation/prompt controls",
        },
        "tool_runtime_wiring_main_llm_loop": "Not Pass",
        "tool_runtime_wiring_research_agent": "Not Pass",
        "tool_runtime_wiring": "Not Pass",
