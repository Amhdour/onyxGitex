...
| PromptInjectionBoundaryDependencyLight | `backend/onyx/security_readiness/prompt_injection_boundary.py` + `security-readiness/evidence-artifacts/prompt-injection-boundary/test_prompt_injection_boundary.py` | No (dependency-light boundary only) | Yes | PASS (8/8) | Yes | Yes (dependency-light only) | Partial positive evidence only; full runtime prompt-injection/red-team remains blocking for GO | Keep `prompt_injection_boundary_tests` strict and blocked until integrated runtime prompt-injection and red-team evidence is PASS. |
...
## Prompt-injection dependency-light evidence note

- Dependency-light prompt-injection boundary tests: **PASS (8/8)**
- Full runtime prompt-injection/red-team status: **NOT_PASS_BLOCKED**
- Evidence type: **dependency-light boundary test evidence**
- Runtime proof: **No**
- Launch gate effect: **partial positive evidence only; GO remains blocked until full runtime prompt-injection/red-team evidence passes**
