...
## Diagram Reference
- `security-readiness/03-threat-model/diagrams/attack-paths.mmd`
- `security-readiness/03-threat-model/diagrams/abuse-case-map.mmd`
- `security-readiness/03-threat-model/diagrams/threat-to-control-map.mmd`
